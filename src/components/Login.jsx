...
const Login = () => {
    ...
    // Handle OAuth success/failure from URL params
    useEffect(() => {
        ...
        if (token) {
            // OAuth success - context will handle this
            setIsLoading(false);
            ...
            <div className="max-w-md w-full">
                <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-100">
                    <div className="text-center mb-8">
                        <div className="mx-auto w-20 h-20 bg-gradient-to-r rounded-full flex items-center justify-center mb-6 shadow-lg">
                            <span className=" text-3xl"><FaSyringe /></span>
                        </div>
                        <h1 className="text-3xl font-bold text-gray-800 mb-2">Welcome to Ayura Lab</h1>

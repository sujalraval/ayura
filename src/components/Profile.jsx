    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="flex flex-col min-h-screen">
                ...
                {/* Header Spacer - Exact height to match your header */}
                <div className="h-[100px] md:h-[120px] flex-shrink-0"></div>

                {/* Navigation Tabs - Sticky below header */}
                <div
                    className="bg-white shadow-sm border-b border-gray-200 sticky z-30 flex-shrink-0"
                    style={{ top: '100px' }}
                >
                        ...
                        <nav className="flex space-x-6 md:space-x-8 overflow-x-auto">
                            {['overview', 'orders', 'family'].map((tab) => (
                                <button
                                    ...
                                    className={`whitespace-nowrap py-3 md:py-4 px-1 border-b-2 font-medium text-sm md:text-base transition-colors duration-200 ${activeTab === tab
                ...
                {/* Main Content Area */}
                <main className="flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-6 mb-16 md:mb-6">
                    {activeTab === 'overview' && (
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                                    ...
                                    <div className="bg-white rounded-lg md:rounded-xl shadow-sm border border-gray-100">
                                        <div className="p-4 md:p-6">
                                            <div className="flex items-center justify-between mb-4">
                                                <h3 className="text-lg md:text-xl font-semibold text-gray-900">Recent Orders</h3>
                                ...
                                {/* Health Insights - Takes 1 column */}
                    ...
                    {activeTab === 'orders' && (
                        <div className="bg-white rounded-lg md:rounded-xl shadow-sm border border-gray-100">
                            <div className="p-4 md:p-6">
                                <h2 className="text-xl md:text-2xl font-semibold text-gray-900 mb-6">All Orders</h2>
                                <Orders />
                            </div>
                        </div>
                    )}
                    ...
                    {activeTab === 'family' && (
                        <div className="bg-white rounded-lg md:rounded-xl shadow-sm border border-gray-100">
                            <div className="p-4 md:p-6">
                                <h2 className="text-xl md:text-2xl font-semibold text-gray-900 mb-6">Family Health</h2>
                                <FamilyHealth />
                            </div>
                        </div>
                    )}
                    ...
                    <div className="mt-12 max-w-md mx-auto">
                        <div className="bg-white rounded-lg md:rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300">
